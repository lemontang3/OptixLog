"""
Plot Radiation Pattern Dipole.Py with OptixLog Integration

Dipole radiation analysis

Based on the Meep tutorial: plot_radiation_pattern_dipole.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="plot_radiation_pattern_dipole_simulation",
        config={
            "simulation_type": "dipole",
            "description": "Dipole radiation analysis",
            "framework": "meep",
            "original_file": "plot_radiation_pattern_dipole.py"
        },
