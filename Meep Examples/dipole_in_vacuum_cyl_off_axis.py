"""
Dipole In Vacuum Cyl Off Axis.Py with OptixLog Integration

Dipole radiation analysis

Based on the Meep tutorial: dipole_in_vacuum_cyl_off_axis.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="dipole_in_vacuum_cyl_off_axis_simulation",
        config={
            "simulation_type": "dipole",
            "description": "Dipole radiation analysis",
            "framework": "meep",
            "original_file": "dipole_in_vacuum_cyl_off_axis.py"
        },
...
def dipole_in_vacuum(
    ...
    sim.run(
        until_after_sources=mp.stop_when_fields_decayed(
            20.0, src_cmpt, mp.Vector3(dipole_pos_r, 0, 0)
