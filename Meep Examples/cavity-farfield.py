"""
Cavity Farfield.Py with OptixLog Integration

Cavity mode analysis

Based on the Meep tutorial: cavity-farfield.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="cavity-farfield_simulation",
        config={
            "simulation_type": "cavity",
            "description": "Cavity mode analysis",
            "framework": "meep",
            "original_file": "cavity-farfield.py"
        },
