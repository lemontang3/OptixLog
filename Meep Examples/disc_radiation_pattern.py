"""
Disc Radiation Pattern.Py with OptixLog Integration

Electromagnetic simulation

Based on the Meep tutorial: disc_radiation_pattern.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="disc_radiation_pattern_simulation",
        config={
            "simulation_type": "general",
            "description": "Electromagnetic simulation",
            "framework": "meep",
            "original_file": "disc_radiation_pattern.py"
        },
