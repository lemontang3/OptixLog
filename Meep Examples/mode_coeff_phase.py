"""
Mode Coeff Phase.Py with OptixLog Integration

Electromagnetic simulation

Based on the Meep tutorial: mode_coeff_phase.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="mode_coeff_phase_simulation",
        config={
            "simulation_type": "general",
            "description": "Electromagnetic simulation",
            "framework": "meep",
            "original_file": "mode_coeff_phase.py"
        },
