"""
Metasurface Lens.Py with OptixLog Integration

Electromagnetic simulation

Based on the Meep tutorial: metasurface_lens.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="metasurface_lens_simulation",
        config={
            "simulation_type": "general",
            "description": "Electromagnetic simulation",
            "framework": "meep",
            "original_file": "metasurface_lens.py"
        },
