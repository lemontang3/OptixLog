"""
Binary Grating Phasemap.Py with OptixLog Integration

Grating diffraction analysis

Based on the Meep tutorial: binary_grating_phasemap.py
"""
...
project_name = os.getenv("OPTIX_PROJECT", "HelloWorld")
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="binary_grating_phasemap_simulation",
        config={
            "simulation_type": "grating",
            "description": "Grating diffraction analysis",
            "framework": "meep",
            "original_file": "binary_grating_phasemap.py"
        },
