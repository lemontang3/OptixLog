"""
Dipole In Vacuum 1D.Py with OptixLog Integration

Dipole radiation analysis

Based on the Meep tutorial: dipole_in_vacuum_1D.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="dipole_in_vacuum_1D_simulation",
        config={
            "simulation_type": "dipole",
            "description": "Dipole radiation analysis",
            "framework": "meep",
            "original_file": "dipole_in_vacuum_1D.py"
        },
