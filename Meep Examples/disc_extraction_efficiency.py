"""
Disc Extraction Efficiency.Py with OptixLog Integration

Electromagnetic simulation

Based on the Meep tutorial: disc_extraction_efficiency.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="disc_extraction_efficiency_simulation",
        config={
            "simulation_type": "general",
            "description": "Electromagnetic simulation",
            "framework": "meep",
            "original_file": "disc_extraction_efficiency.py"
        },
