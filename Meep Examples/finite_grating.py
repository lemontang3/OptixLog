"""
Finite Grating.Py with OptixLog Integration

Grating diffraction analysis

Based on the Meep tutorial: finite_grating.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="finite_grating_simulation",
        config={
            "simulation_type": "grating",
            "description": "Grating diffraction analysis",
            "framework": "meep",
            "original_file": "finite_grating.py"
        },
