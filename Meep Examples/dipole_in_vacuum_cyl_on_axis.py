"""
Dipole In Vacuum Cyl On Axis.Py with OptixLog Integration

Dipole radiation analysis

Based on the Meep tutorial: dipole_in_vacuum_cyl_on_axis.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="dipole_in_vacuum_cyl_on_axis_simulation",
        config={
            "simulation_type": "dipole",
            "description": "Dipole radiation analysis",
            "framework": "meep",
            "original_file": "dipole_in_vacuum_cyl_on_axis.py"
        },
