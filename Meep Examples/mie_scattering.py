"""
Mie Scattering.Py with OptixLog Integration

Scattering analysis

Based on the Meep tutorial: mie_scattering.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="mie_scattering_simulation",
        config={
            "simulation_type": "scattering",
            "description": "Scattering analysis",
            "framework": "meep",
            "original_file": "mie_scattering.py"
        },
