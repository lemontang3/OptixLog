"""
Stochastic Emitter Line.Py with OptixLog Integration

Electromagnetic simulation

Based on the Meep tutorial: stochastic_emitter_line.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="stochastic_emitter_line_simulation",
        config={
            "simulation_type": "general",
            "description": "Electromagnetic simulation",
            "framework": "meep",
            "original_file": "stochastic_emitter_line.py"
        },
