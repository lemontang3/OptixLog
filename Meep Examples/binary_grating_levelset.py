"""
Binary Grating Levelset.Py with OptixLog Integration

Grating diffraction analysis

Based on the Meep tutorial: binary_grating_levelset.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="binary_grating_levelset_simulation",
        config={
            "simulation_type": "grating",
            "description": "Grating diffraction analysis",
            "framework": "meep",
            "original_file": "binary_grating_levelset.py"
        },
