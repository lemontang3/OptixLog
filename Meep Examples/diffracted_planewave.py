"""
Diffracted Planewave.Py with OptixLog Integration

Electromagnetic simulation

Based on the Meep tutorial: diffracted_planewave.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="diffracted_planewave_simulation",
        config={
            "simulation_type": "general",
            "description": "Electromagnetic simulation",
            "framework": "meep",
            "original_file": "diffracted_planewave.py"
        },
