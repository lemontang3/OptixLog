"""
Polarization Grating.Py with OptixLog Integration

Grating diffraction analysis

Based on the Meep tutorial: polarization_grating.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="polarization_grating_simulation",
        config={
            "simulation_type": "grating",
            "description": "Grating diffraction analysis",
            "framework": "meep",
            "original_file": "polarization_grating.py"
        },
