"""
Multilayer Opt.Py with OptixLog Integration

Electromagnetic simulation

Based on the Meep tutorial: multilayer_opt.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="multilayer_opt_simulation",
        config={
            "simulation_type": "general",
            "description": "Electromagnetic simulation",
            "framework": "meep",
            "original_file": "multilayer_opt.py"
        },
