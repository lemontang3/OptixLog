"""
Planar Cavity Ldos.Py with OptixLog Integration

Cavity mode analysis

Based on the Meep tutorial: planar_cavity_ldos.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="planar_cavity_ldos_simulation",
        config={
            "simulation_type": "cavity",
            "description": "Cavity mode analysis",
            "framework": "meep",
            "original_file": "planar_cavity_ldos.py"
        },
