"""
Waveguide Crossing.Py with OptixLog Integration

Waveguide simulation and analysis

Based on the Meep tutorial: waveguide_crossing.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="waveguide_crossing_simulation",
        config={
            "simulation_type": "waveguide",
            "description": "Waveguide simulation and analysis",
            "framework": "meep",
            "original_file": "waveguide_crossing.py"
        },
