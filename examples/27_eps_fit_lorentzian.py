"""
Eps Fit Lorentzian.Py with OptixLog Integration

Electromagnetic simulation

Based on the Meep tutorial: eps_fit_lorentzian.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="eps_fit_lorentzian_simulation",
        config={
            "simulation_type": "general",
            "description": "Electromagnetic simulation",
            "framework": "meep",
            "original_file": "eps_fit_lorentzian.py"
        },
