"""
Mode Converter.Py with OptixLog Integration

Electromagnetic simulation

Based on the Meep tutorial: mode_converter.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="mode_converter_simulation",
        config={
            "simulation_type": "general",
            "description": "Electromagnetic simulation",
            "framework": "meep",
            "original_file": "mode_converter.py"
        },
