"""
Mpb Line Defect.Py with OptixLog Integration

MPB eigenmode analysis

Based on the Meep tutorial: mpb_line_defect.py
"""
...
try:
    ...
    client = optixlog.init(
        ...
        run_name="mpb_line_defect_simulation",
        config={
            "simulation_type": "mpb_eigenmode",
            "description": "MPB eigenmode analysis",
            "framework": "meep",
            "original_file": "mpb_line_defect.py"
        },
